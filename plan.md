...
- [ ] Fase 2 — sedang berjalan; route `directional-paper`, `aggressive-paper`, `operations`, `market-data`, dan `paper-agent` selesai diekstrak (5 dari 8 slice), berikutnya `learning`.
